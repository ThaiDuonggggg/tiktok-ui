...
export const MessIcon = ({ className, width = '2.6rem', height = '2.6rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const FollowingActiveIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <div className={cx('fix-icon')}>
        <svg
            fill="currentColor"
            className={className}
...
export const UserActiveIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
